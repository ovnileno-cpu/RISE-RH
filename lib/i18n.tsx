...
export const translations = {
  fr: {
    ...
    'signup.button': 'S\'inscrire avec Google',
    'signup.requestSent': 'Votre demande a été envoyée. Veuillez attendre la confirmation du RH.',
    ...
    'payroll.form.employee': 'Employé',
    'payroll.form.baseSalary': 'Salaire de base',
    'payroll.form.overtime': 'Heures supplémentaires',
    'payroll.form.deductions': 'Déductions',
    'payroll.form.netCalculated': 'Salaire net calculé',
    'payroll.form.generatePdf': 'Générer fiche de paie PDF',
    'payroll.history': 'Historique des fiches générées par employé',
    'payroll.selectEmployeeForHistory': 'Sélectionnez un employé pour voir son historique.',
    'payroll.noHistory': 'Aucune fiche générée pour cet employé.',
    ...
    'employees.undefinedDepartment': 'Non défini',
    ...
    'training.join': 'S\'inscrire',
    'training.leave': 'Se retirer',
    'training.notice.created': 'Formation créée avec succès.',
    'training.notice.createError': 'Impossible de créer la formation.',
    'training.notice.joined': 'Inscription à la formation effectuée.',
    'training.notice.left': 'Désinscription de la formation effectuée.',
    'training.notice.statusUpdated': 'Statut de formation mis à jour.',
    'training.notice.updateError': 'La mise à jour a échoué.',
    ...
    'eval.noComments': 'Aucun commentaire',
    'eval.pdf.title': 'RISE HR - Rapport d\'Évaluation',
    'eval.notice.created': 'Évaluation créée avec succès.',
    'eval.notice.createError': 'Impossible de créer l\'évaluation.',
    'eval.notice.invalidScore': 'Le score doit être compris entre 1 et 5.',
  ...
  mg: {
    ...
    'signup.button': 'Hisoratra amin\'ny Google',
    'signup.requestSent': 'Vita ny fandefasana fangatahanao. Andraso ny fanamafisan\'ny RH.',
    ...
    'payroll.form.employee': 'Mpiasa',
    'payroll.form.baseSalary': 'Karama fototra',
    'payroll.form.overtime': 'Ora fanampiny',
    'payroll.form.deductions': 'Fanalana',
    'payroll.form.netCalculated': 'Karama net kajiana',
    'payroll.form.generatePdf': 'Hamoaka PDF taratasy karama',
    'payroll.history': 'Tantaran\'ny taratasy karama navoaka isaky ny mpiasa',
    'payroll.selectEmployeeForHistory': 'Safidio ny mpiasa raha hijery ny tantarany.',
    'payroll.noHistory': 'Tsy mbola misy taratasy karama navoaka ho an\'ity mpiasa ity.',
    ...
    'employees.undefinedDepartment': 'Tsy voafaritra',
    ...
    'training.table.actions': 'Hetsika',
    ...
    'training.join': 'Hisoratra anarana',
    'training.leave': 'Hiala',
    'training.notice.created': 'Voaforona soa aman-tsara ny fiofanana.',
    'training.notice.createError': 'Tsy afaka namorona fiofanana.',
    'training.notice.joined': 'Vita ny fisoratana anarana amin\'ny fiofanana.',
    'training.notice.left': 'Vita ny fialana amin\'ny fiofanana.',
    'training.notice.statusUpdated': 'Navaozina ny satan\'ny fiofanana.',
    'training.notice.updateError': 'Tsy nahomby ny fanavaozana.',
    ...
    'eval.noComments': 'Tsy misy fanamarihana.',
    'eval.pdf.title': 'RISE HR - Tatitra fanombanana',
    'eval.notice.created': 'Vita soa aman-tsara ny famoronana fanombanana.',
    'eval.notice.createError': 'Tsy afaka namorona fanombanana.',
    'eval.notice.invalidScore': 'Tokony ho eo anelanelan\'ny 1 sy 5 ny naoty.',
